...
import com.ravi.bean.Customer;
import com.ravi.bean.Employee1;
import com.ravi.bean.Student;
...
public class ConstructorVsSetterInjectionTest {
	...
	public static void main(String[] args) {
		 DefaultListableBeanFactory factory=new DefaultListableBeanFactory();
		  ...
		  reader.loadBeanDefinitions("com/ravi/cfgs/applicationContext.xml");
